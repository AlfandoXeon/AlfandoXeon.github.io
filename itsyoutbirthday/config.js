...
const CONFIG = {
  ...
  music: "./music/hbd.mpeg",       // Musik latar belakang

  // ── Tema & Warna ──────────────────────────────────────────────
  colors: {
    primary: "#f43f5e",            // Rose / Pink Romantis
    accent: "#a855f7",             // Ungu Violet Mewah
    dark: {
      background: "#090d16",       // Midnight Navy Gelap
  ...
  sections: [
    ...
    // 4. Catatan Spesial Angka 7 & Cristiano Ronaldo
    {
      ...
      sender: "Glorius Paskan Danu",
      message:
        "Tanggal 7 hari ulang tahunmu. Wah, angka 7! Nomor punggung Cristiano Ronaldo, sekaligus nomor favoritku. Semoga angka 7 ini membawa banyak keberuntungan, kebahagiaan, dan hal-hal indah untukmu. ❤️",
    ...
    // 9. Sorotan Foto Profil & Doa Penuh Makna
    {
      ...
      wishTitle: "Dirayakan Dengan Cinta",
      wishText:
    ...
    // 13. Pesan Penutup & Tombol Putar Ulang
    {
      ...
      signature: "Tertanda dengan penuh cinta,<br><strong>Glorius Paskan Danu ❤️</strong>",
